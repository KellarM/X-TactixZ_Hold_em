...
export default function ColorBoard({ odds, bets, caps, onPlace, onRemove }) {
  ...
  return (
    <div className="rounded-lg p-3 flex flex-col h-full" style={{ background: 'var(--theme-bg, #0a162e)', border: '1.5px solid #C5A059' }}>
...
export function CapBadge({ value }) {
  return (
    <span
      ...
      style={{ background: 'var(--theme-bg, #000000)', border: '1px solid #C5A059', color: '#FFD700', fontSize: 9, fontWeight: 700 }}
    >
